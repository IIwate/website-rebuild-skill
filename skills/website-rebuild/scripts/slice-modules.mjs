 ...
 *
 *   node tools/slice-modules.mjs --closure docs/slice-closure.json
...
const header = [
  `// AUTO-GENERATED by tools/slice-modules.mjs — DO NOT EDIT BY HAND.`,
  `//`,
  ...
  `//`,
  `// Regenerate:  node tools/slice-modules.mjs --closure ${path.relative(process.cwd(), CLOSURE)}`,
  `// Verify:      node tools/slice-modules.mjs --closure ${path.relative(process.cwd(), CLOSURE)} --check`,
  `//`,
