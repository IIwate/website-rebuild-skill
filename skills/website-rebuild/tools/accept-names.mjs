#!/usr/bin/env node
/**
 * Accept tier-1 names proposed by name-modules.
 * Tier 1 uses packer-declared exports; lower tiers retain module IDs. Duplicate
 * names receive an ID suffix. The acceptance reason is stored in the why field.
 * Based on the darkroom module naming workflow.
 */
