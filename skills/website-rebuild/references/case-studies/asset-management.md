# case-studies/asset-management.md - 资产来源、工作区复用与交付 的实证记录
...
| 做法 | 项目 | 要点 |
|---|---|---|
| 1) 全量复制 + 哈希验证 | [rogier] | `public/` 与源站逐字节一致, 且真的验证过:116 个非视频文件 byte-identical, 23 个视频 size 匹配, 3 个不一致的 png 替换为源站字节; 约 111MB 媒体直接进 git,部署只上 `dist/`.**一代做法, 后代全部演进为不复制** |
